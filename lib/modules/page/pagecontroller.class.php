...
class PageController extends CmsController {
	...
	public function __construct($sMethod) {
		...
		$oMainMenu->addItem(new MenuItem(Conf::get('general.url.www').'/page/editpage', 'new Page', ''));
		$oMainMenu->addItem(new MenuItem(Conf::get('general.url.www').'/page/editfolder', 'new Folder', ''));
	}
